...
const CreateRoutineMachineLayer = () => {
  ...
  let waypoints = [
    L.latLng(
      stationsTwoRoute[stationsTwoRoute.length - 1].lat,
      stationsTwoRoute[stationsTwoRoute.length - 1].lon
    ),
...
const RoutingDestinationTwoRoute = createControlComponent(
  CreateRoutineMachineLayer
);

export default RoutingDestinationTwoRoute;
