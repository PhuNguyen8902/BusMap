      ...
      >
        ...
        <Stack>
          ...
          >
            ...
            <Stack>
              ...
              <Typography sx={{ fontSize: "1vw" }}>
                Go to station: {selectRoute.midRoute.startStation.name}
              </Typography>
            </Stack>
          </Box>
        </Stack>
            ...
            <Stack direction={"row"} sx={{ marginBottom: "4%" }}>
              ...
              <Typography sx={{ fontSize: "1.1vw" }}>
                <strong>
                  ...
                  route {selectRoute.midRoute.route.routeNum}
                </strong>
              </Typography>
            </Stack>
            <Box>
              <Typography sx={{ fontSize: "1vw" }}>
                Get off at station: {selectRoute.midRoute.startStation.name}
              </Typography>
              <Typography sx={{ fontSize: "1vw" }}>
                With the address: {selectRoute.midRoute.startStation.address}
              </Typography>
            </Box>
          </Box>
        </Stack>
        <Stack>
          ...
          >
            ...
            <Stack>
              <Typography sx={{ fontSize: "1vw" }}>
                From station: {selectRoute.midRoute.startStation.name}
              </Typography>
              <Typography sx={{ fontSize: "1vw" }}>
                Go to station: {selectRoute.midRoute.endStation.name}
              </Typography>
            </Stack>
          </Box>
        </Stack>
        <Stack>
          ...
          >
            <Stack direction={"row"} sx={{ marginBottom: "4%" }}>
              ...
              <Typography sx={{ fontSize: "1.1vw" }}>
                <strong>
                  Change From route {selectRoute.midRoute.route.routeNum} to
            ...
            <Box>
              <Typography sx={{ fontSize: "1vw" }}>
                Get off at station: {selectRoute.midRoute.endStation.name}
              </Typography>
              <Typography sx={{ fontSize: "1vw" }}>
                With the address: {selectRoute.midRoute.endStation.address}
              </Typography>
            </Box>
          </Box>
        </Stack>
        <Stack>
          ...
          >
            ...
            <Stack>
              <Typography sx={{ fontSize: "1vw" }}>
                From station: {selectRoute.midRoute.endStation.name}
              </Typography>
              <Typography sx={{ fontSize: "1vw" }}>
                Go to station:{" "}
