                ...
                <Stack>
                    <Box sx={{ background: "rgba(0, 0, 0, 0.05)", borderRadius: "20px", padding: "5%", marginBottom: "5%" }}>
                        ...
                        <Stack>
                            ...
                            <Typography sx={{ fontSize: "1vw" }}>Go to station: {selectRoute.midStation.name}</Typography>
                        </Stack>
                    </Box>
                </Stack>
                <Stack>
                    <Box sx={{ background: "rgba(0, 0, 0, 0.05)", borderRadius: "20px", padding: "5%", marginBottom: "5%" }}>
                        <Stack direction={"row"} sx={{ marginBottom: "4%" }}>
                            ...
                            <Typography sx={{ fontSize: "1.1vw" }}>
                                <strong>
                                    Change From route {selectRoute.startStation.stationRoute.routeId.routeNum} to route {selectRoute.endStation.stationRoute.routeId.routeNum}
                                </strong>
                            </Typography>   
                        </Stack>
                        <Box>
                            <Typography sx={{ fontSize: "1vw" }}>Get off at station: {selectRoute.midStation.name}</Typography>
                            <Typography sx={{ fontSize: "1vw" }}>With the address: {selectRoute.midStation.address}</Typography>
                        </Box>
                    </Box>
                </Stack>
                <Stack>
                    <Box sx={{ background: "rgba(0, 0, 0, 0.05)", borderRadius: "20px", padding: "5%", marginBottom: "5%" }}>
                        ...
                        <Stack>
                            <Typography sx={{ fontSize: "1vw" }}>From station: {selectRoute.midStation.name}</Typography>
