                  ...
                  <Stack direction={"row"} sx={{ marginBottom: "4%" }}>
                    ...
                    <Typography sx={{ fontSize: "1.2vw" }}>
                      <strong>
                        walk to route{" "}
                        {
                          routeWithThreeTripData.startStation.stationRoute
                            .routeId.routeNum
                        }
                      </strong>
                    </Typography>
                  ...
                  <Stack direction={"row"} sx={{ marginBottom: "4%" }}>
                    ...
                    <Typography sx={{ fontSize: "1.1vw" }}>
                      <strong>
                        ...
                        to route{" "}
                        {routeWithThreeTripData.midRoute.route.routeNum}
                      </strong>
                    </Typography>
                  </Stack>
                  <Box>
                ...
                >
                  <Stack direction={"row"} sx={{ marginBottom: "4%" }}>
                    ...
                    <Typography sx={{ fontSize: "1.1vw" }}>
                      <strong>
                        Change From route{" "}
                        {routeWithThreeTripData.midRoute.route.routeNum} to
                        route{" "}
                        {
...
RouteWithThreetrip.propTypes = {
  steps: PropTypes.object,
  triggerNextStep: PropTypes.func,
};

RouteWithThreetrip.defaultProps = {
  steps: undefined,
