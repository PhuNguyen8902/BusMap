...
import {
  EachElementLookupLikes,
  EachElementStationLookupLikes,
} from '../components/FooterLikes';

export default function FooterLikesPage() {
  ...
  const [routes] = useState([
    {key: 'first', title: 'Tuyến yêu thích'},
    {key: 'second', title: 'Trạm yêu thích'},
  ]);
